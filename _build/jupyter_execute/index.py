...
from ligotools.utils import plotmasta

template_H1, template_L1 = plotmasta(fs,template_p,template_c,time,template_offset,strain_H1,dt,bb,ab,normalization,make_plots,strain_H1_whitenbp,
          eventname,plottype,tevent,strain_L1,strain_L1_whitenbp)
...
fmtcsv = ",".join(["%10.6f"] * 5)
np.savetxt('audio/'+fncsv, datcsv, fmt=fmtcsv, header=headcsv)
